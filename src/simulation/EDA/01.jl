...
plot!(pp01_04, 2012:yend, age_r[:,2], color =    red, fa = .5, fillrange = age_r[:,1], label = "Elder Dependency Ratio")
plot!(pp01_04, 2012:yend, age_r[:,1], color = yellow, fa = .5, fillrange = 0         , label = "Child Dependency Ratio")
...
pp01_06 = plot(legend = :bottomleft,
    ...
    ylabel = "Number")
plot!(pp01_06, 2012:yend, filter(:age => age -> age == 0, rslt) |> ts_sum, fa = .5, fillrange = 0, color = :green, label = "Birth")
plot!(pp01_06, 2012:yend, -(dead |> ts_sum),                               fa = .5, fillrange = 0, color = :black, label = "Death")
...
plot!(pp01_08, 0:99, df_age.y2012[1:100], label = "2012", lw = 2, color = :black)
...
plot!(pp01_09, 0:99, df_age.y2012[1:100], label = "2012", lw = 2, color = :black)
plot!(pp01_09, 0:99, df_age.y2046[1:100], label = "2046", lw = 2, color = :navy)
plot!(pp01_09, 25:99, df_age.y2012[1:75], label = :none, lw = 2, color = :black, ls = :dash, alpha = 0.5)
...
pp01_11 = plot(legend = :topright,
    xlims = (2012, yend), ylims = (0,100), xticks = [2012, (2030:10:yend)...], yticks = 0:50:100,
