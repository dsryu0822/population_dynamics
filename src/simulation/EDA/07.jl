...
plot!(pp07_01, 0:99, df_age.y2021[1:100], label = "2021", lw = 2, color = :black)
...
pp07_02 = plot(legend = :topright,
    ...
    ylabel = "Population")
plot!(pp07_02, 2021:yend, age_c[:,3], color =    red, fa = .5, fillrange = age_c[:,2], label = "65-")
plot!(pp07_02, 2021:yend, age_c[:,2], color = orange, fa = .5, fillrange = age_c[:,1], label = "15-64")
plot!(pp07_02, 2021:yend, age_c[:,1], color = yellow, fa = .5, fillrange = 0         , label = "-14")
...
plot!(pp07_04, 2021:yend, age_migration[:,3], color =    red, msw = 0, shape = :circ, lw = 2, fa = 0.1, fillrange = 0, label = "65-")
plot!(pp07_04, 2021:yend, age_migration[:,2], color = orange, msw = 0, shape = :rect, lw = 2, fa = 0.1, fillrange = 0, label = "15-64")
plot!(pp07_04, 2021:yend, age_migration[:,1], color = yellow, msw = 0, shape = :diamond, lw = 2, fa = 0.1, fillrange = 0, label = "-14")
png(pp07_04, "G:/figure/subfigure/07 0 capital pp07_04.png")

pp07_06 = plot(legend = :bottomleft,
    xlims = (2021, yend), xticks = [2021, (2030:10:yend)...],
    ylabel = "Number")
plot!(pp07_06, 2021:yend, birth, fa = .5, fillrange = 0, color = :green, label = "Birth")
plot!(pp07_06, 2021:yend, -death, fa = .5, fillrange = 0, color = :black, label = "Death")
png(pp07_06, "G:/figure/subfigure/07 0 capital pp07_06.png")
    
pp07_08 = plot(ylabel = "Number", xlabel = "Year", xticks = [2021, (2030:10:yend)...], xlims = (2021, yend))
plot!(pp07_08, 2021:yend, netmigrat, lw = 2, fa = .5, fillrange = 0, color = :olive, label = "net migration")
plot!(pp07_08, 2021:yend, netgrowth, lw = 2, fa = .5, fillrange = 0, color = :darkgreen, label = "net growth")
